  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Container(
        ...
        color: Color.fromARGB(255, 108, 223, 123),
        child: Content(),
      ),
    );
  }
...
class Content extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Counter('6488111'),
        Counter('Tunjeera Wangsri'),
        Counter('Currency Converter'),
        Counter('6488013,6488064,6488111,6488192'),
      ],
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(color: Color.fromARGB(255, 255, 255, 254)),
